...
import goodtime_productivity.shared.generated.resources.settings_add_custom_sound
import goodtime_productivity.shared.generated.resources.settings_your_sounds
        ...
        platformSpecificContent = {
            ...
            items(userItems.toList(), key = { "user" + it.uriString }) { item ->
                ...
                NotificationSoundItem(
                    ...
                    onSelected(item)
                    coroutineScope.launch {
                        soundPlayer.play(item, loop = false)
                    }
                }
            }
